...
public class CommonConstants {
	...
	public static final String ROOM_ID_PREFIX = "E300";
	...
	public static final String QUERY_ID_CREATE_ROOM_TABLE = "create_addroom_table";

	/** Constant for query id of insert employees in EmployeeQuery.xml */
	public static final String QUERY_ID_INSERT_ROOM = "insert_room";
